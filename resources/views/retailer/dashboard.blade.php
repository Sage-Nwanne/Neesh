  ...
  <body>
      ...
      <div class="page__container page-width">
          <div class="page-wrap">
              <div class="photostack-container" aria-label="Magazine stack">
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 1.png')}}" alt="Cover 1">
                  ...
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 2.png')}}" alt="Cover 2">
                          <div class="Catalogue_visible_text">
                              <div class="product_info">
                  ...
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 3.png')}}" alt="Cover 3">
                          <div class="Catalogue_visible_text">
                              <div class="product_info">
                  ...
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 4.png')}}" alt="Cover 4">
                          <div class="Catalogue_visible_text">
                              <div class="product_info">
                  ...
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 5.png')}}" alt="Cover 5">
                          <div class="Catalogue_visible_text">
                              <div class="product_info">
                  ...
                  <div class="photo-item">
                      ...
                      <a href="#" class="Catalogue_anchour"><img src="{{asset('assets/image/Catalogue 6.png')}}" alt="Cover 6">
                          <div class="Catalogue_visible_text">
                              <div class="product_info">
          ...
          <a href="#" class="product-card product-card-underline">
