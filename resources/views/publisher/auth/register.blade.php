...
<head>
    ...
    .formimagesshow {
        display: flex;
        flex-wrap: wrap; /* agar jyada images ho to next line mai chale jaen */
        gap: 10px;
        margin-top: 15px;
    }
...
<form method="POST" id="multiStepForm" action="{{ route('register') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="publisher_form_input_display">
                                ...
                                <div class="input_block">
                                    ...
                                    <div class="publisher_formfields">
                                        <input class="uptitle-input-text" id="firstname" name="firstname" type="text" placeholder="First Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="input_block">
                                    ...
                                    <div class="publisher_formfields">
                                        <input class="uptitle-input-text" id="lastname" name="lastname" type="text" placeholder="Last Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="input_block">
                                    ...
                                    <div class="publisher_formfields">
                                        <input class="uptitle-input-text" id="bussinessname" name="bussinessname" type="text" placeholder="Business Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="input_block">
                                    ...
                                    <div class="publisher_formfields">
                                        <input class="uptitle-input-text" id="publisheremail" name="email" type="email" placeholder="Email" required
                                ...
                                <div class="input_block">
                                    ...
                                    <div class="publisher_formfields">
                                        <div class="publisher_formfields_innerwrapper">
                                            <input class="uptitle-input-text" id="publisherpassword" name="password" type="password" placeholder="Password" required>
                                            <i class="fa-solid fa-eye publisher-eye-toggle" data-target="publisherpassword"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="publisher_form_input_display">
                                ...
                                <div class="publisher_formfields">
                                    ...
                                    <input type="text" id="magazine_title" class="uptitle-input-text" name="magazine_title" placeholder="Full Magazine Title" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="website_link">Website / Social Link</label>
                                    <input type="text" id="website_link" class="uptitle-input-text" name="website_link" placeholder="Website / Social Link" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="magazinedescription">Description</label>
                                    <textarea name="magazinedescription" id="magazinedescription" placeholder="Description"></textarea>
                                </div>
                            </div>
                            ...
                            <div style="margin-top:14px;">
                                <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
                                    <div class="uploadform_single_and_series_issue_checkbox">
                                        <input type="radio" name="issue_type" value="single" id="single_issue" required>
                                ...
                                <div class="publisher_form_input_display series_fields" id="series_fields" aria-hidden="true">
                                    <div class="publisher_formfields">
                                        <label for="series_issue_count">Number of Issues</label>
                                        <input type="number" id="series_issue_count" class="uptitle-input-text" name="series_issue_count" placeholder="Number of Issues">
                                    </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="publisher_form_input_display">
                                ...
                                <div class="publisher_formfields">
                                    ...
                                    <input type="number" id="print_run" class="uptitle-input-text" name="print_run" placeholder="Print Run" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="available_quantities">Available Quantities</label>
                                    <input type="number" id="available_quantities" class="uptitle-input-text" name="available_quantities" placeholder="Available Quantities" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="wholesale_price">Wholesale Price (WSP)</label>
                                    <input type="number" id="wholesale_price" class="uptitle-input-text" name="wholesale_price" placeholder="Wholesale Price (WSP)" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="retail_price">Suggested Retail Price</label>
                                    <input type="number" id="retail_price" class="uptitle-input-text" name="retail_price" placeholder="Suggested Retail Price" required>
                                </div>
                        ...
                        <div class="form-step">
                            ...
                            <div class="publisher_form_input_display" style="display:flex; flex-wrap:wrap; gap:12px;">
                                ...
                                <div class="publisher_formfields">
                                    ...
                                    <select id="fulfillment_method" class="uptitle-input-text" name="fulfillment_method" required>
                                        <option value="" disabled selected hidden>Select Fulfillment Method</option>
                                ...
                                <div class="publisher_formfields">
                                    ...
                                    <input type="text" id="shipping_city" class="uptitle-input-text" name="shipping_city" placeholder="Shipping City" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="shipping_state">Shipping State</label>
                                    <input type="text" id="shipping_state" class="uptitle-input-text" name="shipping_state" placeholder="Shipping State" required>
                                </div>

                                <div class="publisher_formfields">
                                    <label for="shipping_country">Shipping Country</label>
                                    <input type="text" id="shipping_country" class="uptitle-input-text" name="shipping_country" placeholder="Shipping Country" required>
                                </div>

                                <div class="publisher_formfields" style="flex:1 1 100%;">
                                    <label for="return_policy">Return Policy</label>
                                    <textarea class="uptitle-input-text" id="return_policy" name="return_policy" placeholder="Return Policy" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-step">
                            ...
                            <label for="coverUploadimage" class="uptitle-upload-box">
                                ...
                                <input class="upload" id="coverUploadimage" type="file" name="files[]" multiple accept="image/*" style="display:none;">
                            ...
                            <div class="publisher_form_input_display">
                                <div class="publisher_formfields">
                                    ...
                                    <input type="text" id="promotional_text" class="uptitle-input-text" name="promotional_text" placeholder="Promotional Text" required>
                                </div>
                                <div class="publisher_formfields">
                                    <label for="metadata">Metadata</label>
                                    <input type="text" id="metadata" class="uptitle-input-text" name="metadata" placeholder="Metadata (e.g: ISBN, ISSN, keywords)" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-step">
                            ...
                            <label class="password_label" for="salesexperience">Have you sold this issue before?</label>

                            <div class="publisher_form_input_display">
                                <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
                                    <div class="uploadform_single_and_series_issue_checkbox">
                                        <input type="radio" name="sales_experience" value="yes" id="sales_yes" required>
                                ...
                                <div id="sales_experience_fields" style="display:none; margin-top:15px;">
                                    <div>
                                        ...
                                        <div style="display:flex; flex-wrap:wrap; gap:12px; margin-top:8px;">
                                            <div><input type="checkbox" name="distribution_channels[]" value="online" id="channel_online"><label for="channel_online">Online Directory</label></div>
                                            <div><input type="checkbox" name="distribution_channels[]" value="bookstores" id="channel_bookstores"><label for="channel_bookstores">Local Bookstores</label></div>
                                            <div><input type="checkbox" name="distribution_channels[]" value="news_stands" id="channel_news"><label for="channel_news">News Stands</label></div>
                                            <div><input type="checkbox" name="distribution_channels[]" value="subscription" id="channel_subscription"><label for="channel_subscription">Subscription</label></div>
                                            <div><input type="checkbox" name="distribution_channels[]" value="events" id="channel_events"><label for="channel_events">Events / Markets</label></div>
                                            <div><input type="checkbox" name="distribution_channels[]" value="other" id="channel_other"><label for="channel_other">Other</label></div>
                                        </div>
                                    </div>

                                    <div class="publisher_formfields" style="margin-top:15px;">
                                        <label for="copies_sold">Estimated Copies Sold</label>
                                        <input type="number" id="copies_sold" class="uptitle-input-text" name="copies_sold" placeholder="Estimated Copies Sold">
                                    </div>

                                    <div class="publisher_formfields" style="margin-top:15px;">
                                        <label for="sales_feedback">What feedback have you received?</label>
                                        <textarea class="uptitle-input-text" id="sales_feedback" name="sales_feedback" placeholder="What feedback have you received?" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
